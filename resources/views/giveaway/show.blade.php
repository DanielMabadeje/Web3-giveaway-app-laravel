...
<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('View '.$giveaway->giveaway_name.' Giveaway!') }}
        </h2>
    </x-slot>
                        ...
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            <form>
                                ...
                                <div class="py-80" style="padding: 20px 0px;">
                                    <x-input-label for="wallet_type"
                                        :value="__('Copy the wallet address below and send '.$giveaway->amount.' '.$giveaway->wallet_type->value.' to proceed')" />
                                </div>
                                <div class="w-full">
                                    <div class="relative">
                                        ...
                                        <button data-copy-to-clipboard-target="wallet-address-copy-text"
                                            onclick="event.preventDefault()" style="margin-top: -15px; padding:5px;"
    ...
    <div class="">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="">
                <div class="max-w-7xl mx-auto sm:px-5 lg:px-7 grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    @switch($giveaway->giveaway_type->value)
                        @case('')
                            @break
                        @case('ROUNDROBIN')
                        ...
                        @case('SELECTWINNER')
                            ...
                            @break
                        @default
                            @include('giveaway.partials.view-participants-first-participant', ['giveaway'  =>  $giveaway])
